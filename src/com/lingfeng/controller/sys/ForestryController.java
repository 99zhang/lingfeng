...
import com.lingfeng.service.sys.ForestryService;
import com.lingfeng.service.sys.ForestryTypeService;

import core.extjs.ExtJSBaseParameter;
import core.extjs.ListView;
import core.support.QueryResult;
import core.util.LingfengUtils;
...
public class ForestryController extends LingfengBaseController<Forestry> {
		...
		if (!file.isEmpty()) {
			if (file.getSize() > 2097152) {
				...
				try {
					...
					String fileName = sdf.format(new Date()) + LingfengUtils.getRandomString(3) + originalFilename.substring(originalFilename.lastIndexOf("."));
