...
import com.lingfeng.model.sys.param.SensorDataParameter;
...
public class SensorData extends SensorDataParameter {
	...
	@Column(name = "record_time", columnDefinition = "timestamp null default null on update current_timestamp")
