...
import com.lingfeng.model.sys.param.AuthorityParameter;
...
public class Authority extends AuthorityParameter {
	...
	@Column(name = "expanded", columnDefinition = "tinyint not null default 0")
	private Boolean expanded; //可伸展的
	@Column(name = "checked", columnDefinition = "tinyint")
	private Boolean checked; //可勾选的
	@Column(name = "leaf", columnDefinition = "tinyint not null default 0")
